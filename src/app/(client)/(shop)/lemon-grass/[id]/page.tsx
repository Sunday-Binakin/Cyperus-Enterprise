...
function ProductDetailContent() {
  ...
  const product = LEMON_GRASS_PRODUCTS.find((p) => p.id === params.id);
  ...
  const mockReviews = [
    {
      ...
      user: 'Sarah Johnson',
      rating: 5,
      comment: 'Love the refreshing lemon grass flavor! Perfect blend with tigernuts.',
      date: 'July 15, 2023',
    },
    {
      id: '2',
      user: 'Michael Brown',
      rating: 5,
      comment: 'Best lemon grass tigernut product I have tried. Highly recommended!',
      date: 'July 8, 2023',
    },
  ];
