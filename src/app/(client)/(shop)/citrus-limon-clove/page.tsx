    ...
    <div className="min-h-screen bg-black text-white">
        ...
        >
          <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
            <div className="container mx-auto px-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Citrus Limon & Clove</h1>
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2">
                  ...
                  <li aria-current="page">
                    <div className="flex items-center">
                      ...
                      <span className="ml-1 text-sm font-medium text-white md:ml-2">Citrus Limon & Clove</span>
                    </div>
                  </li>
                </ol>
              </nav>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-4">Our Citrus Limon & Clove Products</h2>
          <div className="w-24 h-1 bg-yellow-500 mx-auto"></div>
        </div>
        <ProductGrid products={CITRUS_LIMON_CLOVE_PRODUCTS} categoryPath="citrus-limon-clove" />
      </div>
    </div>
  );
}
