...
export const WhyCyperus = () => {
    return (
        <div className='flex flex-row items-center justify-center bg-black'>
            <div className=' w-1/2 h-[500px] text-white flex flex-col justify-center items-center'>
                <p className='text-2xl font-bold text-[#EFE554] text-left'>We are Cyperus Enterprise
                    <p className='text-xl text-white mt-2 mb-2'>Our mission is to provide the best quality of life to our customers</p></p>
