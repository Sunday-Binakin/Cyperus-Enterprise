		...
		<section className="bg-black text-white py-16 px-4">
			<div className="container mx-auto max-w-6xl">
				<div className="text-center mb-12">
					<h2 className="text-sm uppercase tracking-wider mb-2" style={{ color: '#4A651F' }}>THE WORD ON THE STREET</h2>
						...
						{testimonials.map((testimonial) => (
							<div key={testimonial.id} className="bg-white rounded-xl p-3  text-gray-800 shadow-lg">
								<div className="flex items-center mb-4">
									<div className="w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl mr-4" style={{ backgroundColor: '#4A651F20', color: '#4A651F' }}>
										{testimonial.initial}
									</div>
									<div>
								...
								<p className="text-gray-700 mb-4">
									<FaQuoteLeft className="inline mr-2" style={{ color: '#4A651F33' }} />
									{testimonial.review}
								</p>
								<a href="#" className="hover:text-[#4A651F] text-sm font-medium" style={{ color: '#4A651F' }}>
									Read more
								</a>
							</div>
						))}
