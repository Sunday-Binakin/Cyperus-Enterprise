...
export default function FormInput({
  ...
  const baseInputClasses = 'w-full px-4 py-3 rounded-md focus:outline-none focus:ring-2 transition-colors';
  ...
  return (
    <div className={containerClassName}>
      ...
      <input
        {...props}
        className={`${baseInputClasses} ${variantClasses[variant]} ${className}`}
      />
      {error && (
